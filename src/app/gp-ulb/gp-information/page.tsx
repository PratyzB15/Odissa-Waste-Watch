...
function GpInformationContent() {
  ...
  useEffect(() => {
    ...
    const formatted = mappedGps.map((gp: any, idx: number) => {
        ...
        <CardHeader className="bg-primary/5 border-b">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
                ...
                <CardDescription>Verified quantification survey data for constituent Gram Panchayats mapped to this facility.</CardDescription>
                </div>
            </div>
            ...
            <ScrollArea className="w-full">
                ...
                <Table className="border-collapse border text-[10px]">
                    ...
                    <TableRow>
                        ...
                        <TableHead className="w-[120px] border font-black uppercase text-center">Actions</TableHead>
                    </TableRow>
                    </TableHeader>
                    <TableBody>
