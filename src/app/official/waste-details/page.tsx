        ...
        <CardHeader className="bg-primary/5 border-b">
          <div className="flex items-center gap-3 text-primary">
            ...
            <div>
              ...
              <CardDescription className="font-bold italic text-muted-foreground">Authoritative oversight for District: {districtName}.</CardDescription>
            </div>
          </div>
        </CardHeader>
      </Card>
                                ...
                                <AccordionContent className="p-0 bg-background">
                                                ...
                                                <TableBody>
                                                    {reconciledRecords.map((row) => (
                                                        <TableRow key={row.id} className="hover:bg-primary/[0.01] border-b last:border-0 h-16 transition-colors">
                                                            ...
                                                            <TableCell className="border-r font-bold uppercase">{row.block}</TableCell>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 bg-muted/5 border-t">
                                        <div className="bg-background border-2 border-dashed rounded-xl p-5 shadow-sm">
                                            <p className="text-[10px] font-black uppercase text-muted-foreground mb-1">District Load on Avg (Month)</p>
                        ...
                        <div className="min-w-[1600px]">
                            <Table>
                                <TableHeader className="bg-muted/50">
                                    <TableRow>
                                        <TableHead className="w-[150px] uppercase font-black border text-center">Block Name</TableHead>
                                ...
                                <TableBody>
                                    {(() => {
                                      ...
                                      yearly.forEach(r => {
                                          const bName = r.block || 'TBD';
                                          const prev = blocksMap.get(bName) || { count: 0, received: 0, paper: 0, plastic: 0, metal: 0, glass: 0, sani: 0 };
                                          blocksMap.set(bName, {
                                              count: prev.count + 1,
                                      ...
                                      return Array.from(blocksMap.entries()).map(([name, stats]) => (
