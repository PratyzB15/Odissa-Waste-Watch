                  ...
                  {allGps.length === 0 ? (
                    ...
                    allGps.map((row, idx) => (
                      <TableRow key={row.id || idx} className="hover:bg-primary/[0.02] border-b h-12">
                        ...
                        <TableCell className="text-center border-r font-mono font-bold text-sm">{parseFloat(row.households as any).toLocaleString()}</TableCell>
                        ...
                        <TableCell className="text-right border-r font-mono font-black text-primary px-4">{parseFloat(row.dailyWaste as any).toLocaleString()}</TableCell>
                        <TableCell className="text-right border-r font-mono font-black text-primary px-4">{parseFloat(row.monthlyWaste as any).toLocaleString()}</TableCell>
                        {isAuthorized && (
