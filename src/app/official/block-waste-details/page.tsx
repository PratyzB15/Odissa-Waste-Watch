                            ...
                            <Card className="overflow-hidden border-2 shadow-xl">
                                ...
                                <AccordionContent className="p-6 space-y-10 bg-background">
                                    <Accordion type="multiple" className="w-full space-y-6">
                                        {ulbGroups.map(ulb => (
                                            <AccordionItem value={`${year}-${month}-${ulb}`} key={ulb} className="border-none">
                                                <Card className="border shadow-sm mb-4">
                                                    <AccordionTrigger className="px-4 py-2 hover:no-underline bg-muted/5"><div className="flex items-center gap-2"><Warehouse className="h-3 w-3 text-primary" /><h4 className="font-black uppercase text-[10px] text-primary">ULB Node: {ulb}</h4></div></AccordionTrigger>
