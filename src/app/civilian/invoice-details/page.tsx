...
import { UploadCloud, Loader2, Save, Calendar, Truck, Anchor, MapPin, Building, Route, ListPlus, Phone, LayoutGrid } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <Card className="border-2 shadow-xl border-primary/20 overflow-hidden">
        ...
        <CardFooter className="bg-primary/5 border-t p-6">
            <Button onClick={handleSubmit} disabled={totalCollected === 0} className="w-full h-14 text-lg font-black uppercase tracking-[0.1em] shadow-xl hover:scale-[1.01] transition-all">
